...
def optimize_currents(B_initial):
    ...
    res = dual_annealing(
        objective,
        bounds=bounds,
        maxiter=40,          # Увеличим число итераций (отжиг требует больше вычислений)
...
visualize_3d_arrays(B_initial_norm, B_compensated_norm, "Исходное поле","Оптимизированное поле")
